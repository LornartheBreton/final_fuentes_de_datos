...
class Logit:
    ...
    def __init__(self, X, y, alpha=.005,err=.01,tol=1e4):
    ...
    def optimize(self, savefig='error.png'):
        '''
        :return:
        '''
        iter = 0
        ...
        print(loss)
        print('Training')
        while loss > self.err and iter < self.Tol:
            if iter % 1000==0:
                print(f'iter: {iter}, loss: {loss}, err: {self.err}')
            iter += 1
